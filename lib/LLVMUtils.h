...
template<int N>
inline llvm::Constant* const_int_value(llvm::LLVMContext& context, uint64_t v)
{
	return llvm::ConstantInt::get(context, llvm::APInt(N, v));
}

inline llvm::Constant* const_int1(llvm::LLVMContext& context, uint64_t v)
{
	return llvm::ConstantInt::get(llvm::Type::getInt1Ty(context), v);
}

inline llvm::Constant* const_int8(llvm::LLVMContext& context, uint64_t v)
{
	return llvm::ConstantInt::get(llvm::Type::getInt8Ty(context), v);
}

inline llvm::Constant* const_int16(llvm::LLVMContext& context, uint64_t v)
{
	return llvm::ConstantInt::get(llvm::Type::getInt16Ty(context), v);
}

inline llvm::Constant* const_int32(llvm::LLVMContext& context, uint64_t v)
{
	return llvm::ConstantInt::get(llvm::Type::getInt32Ty(context), v);
}

inline llvm::Constant* const_int64(llvm::LLVMContext& context, uint64_t v)
{
